...
function start() {
    ...
    const utt = new SpeechSynthesisUtterance("Begin in a prone position on your stomach. Bring the legs together with the tops of the feet on the floor.  Place the hands on opposite sides of the chest and press into the floor, lifting the chest up and forward coming into a back bend. Take the gaze upwards. Hold the asana for about 15 to 30 seconds while breathing normally. Then RELAX.");
